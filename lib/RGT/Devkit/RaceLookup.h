...
/// @brief Проверяет, входит ли пользователь в список участников/тренеров гонки 
/// @param session psql сессия
/// @param pc cоединение с redis
/// @param raceId ID гонки
...
/// @brief Возвращает список участников (яхтсменов) гонки
/// @param session сессия
/// @param pc соединение с redis
/// @param raceId ID гонки
/// @return Список участников гонки
